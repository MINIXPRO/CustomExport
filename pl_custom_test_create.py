...
{%- set ns = namespace(short_name="", total_qty=0, total_sub_qty=0, total_net_weight=0, total_gross_weight=0, total_cbf=0, total_cbm=0) -%}
...
<div class="pl-wrap">
  ...
  <table class="items-table">
    ...
    <tbody>
      ...
      {%- set ns.total_sub_qty    = ns.total_sub_qty + si_qty -%}
      {%- set ns.total_net_weight = ns.total_net_weight + si_net -%}
      ...
      <tr class="total-row">
        ...
        <td>{{ "%.0f"|format((ns.total_qty + ns.total_sub_qty)|float) }}</td>
